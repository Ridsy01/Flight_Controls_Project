...
class dataPlotter:
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0][0], ylabel='Pn(m)', title='Control Angles'))
        self.handle.append(myPlot(self.ax[1][0], ylabel='Pe(m)'))
        self.handle.append(myPlot(self.ax[2][0], ylabel='Pd(m)'))
    ...
    def update(self, t, state):
        ...
        self.handle[0].update(self.time_history, [self.pn_history])
        self.handle[1].update(self.time_history, [self.pe_history])
        self.handle[2].update(self.time_history, [self.pd_history])
