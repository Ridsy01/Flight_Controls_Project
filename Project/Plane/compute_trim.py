...
from Assignment1.tools.rotations import Quaternion2Euler, Quaternion2Rotation, Euler2Rotation
...
class ComputeTrim:
    def __init__(self):
        ...
        self.forces_mom = forcemoment()
        self.mav = planeDynamics(P.ts_simulation, P.states0)
    ...
    def compute_trim_cost(self, x, Va, Y, R):
        ...
        f_m = self.forces_mom.f_m(x_trim, u_trim)
